...
insert into dates (couple_id, name, description, budget, num_view, post_updated, created, modified) values 
    ...
    (3, "池袋コスプレデート", "コスプレをして池袋を徘徊してきましたwww", "6000", 7, now(), now(),now()),
    (3, "鎌倉プチ旅行デート", "少し遠出をしてきました。鎌倉へのドライブ旅行です。", "6000", 7, now(), now(),now()),
...
insert into posts (date_id, content, city, state, created, modified) values 
    (1, "ヒカリエに集合！天気も良好◎　さすが晴れ男！！", "渋谷", "東京都", now()- INTERVAL 8 HOUR, now()),
    (1, "ハチ公前で写真撮影！いぇーい！！", "渋谷", "東京都", now()- INTERVAL 6 HOUR, now()),
    (1, "TOHOシネマで映画鑑賞！疲れてたからちょっと寝ちゃった…笑", "渋谷", "東京都", now()- INTERVAL 5 HOUR, now()),
    (1, "楽天カフェで一休み！ワンピースの音楽が永遠リピート。。。懐かしい！！", "渋谷","東京都", now()- INTERVAL 3 HOUR, now()),
    (1, "LOFTでお買い物！二人でお揃いの手帳ゲッチュ(*^^*)カラクリすごかった！！", "渋谷","東京都", now()- INTERVAL 1.5 HOUR, now()),
    (1, "ディナーは予約してました！美味しい料理がたくさんあって幸せだった♪", "原宿", "東京都", now()- INTERVAL 1 HOUR, now()),
    (1, "寂しいけど、ばいばーい（泣）夜景すごくキレイだった！！", "表参道", "東京都", now()- INTERVAL 5 MINUTE, now()),
    ...
    (4, "駅前で集合、彼氏が遅刻！", "藤沢駅", "神奈川県", now()- INTERVAL 9 HOUR, now()),
    (4, "はじめての江ノ電！ローカル線すぎるー！ゆっくり動くー！", "江の電", "神奈川県", now()- INTERVAL 8 HOUR, now()),
    (4, "江ノ電で途中下車、スラムダンク発祥の高校があるみたい", "七里ガ浜駅", "神奈川県", now()- INTERVAL 5.5 HOUR, now()),
    (4, "江の島到着！江の島って橋を渡っていけるんだね！散歩行ってきまーす！", "江の島", "神奈川県", now()- INTERVAL 4.5 HOUR, now()),
    (4, "江の島といえば、しらす丼だよね！美味しい！", "江の島", "神奈川県", now()- INTERVAL 3 HOUR, now()),
    (4, "夜も綺麗な江の島ー！でもお店閉まるの早すぎ！早めの帰宅ー", "江の島", "神奈川県", now()- INTERVAL 1 HOUR, now()),
    (4, "家に帰って来ちゃった〜！江の島散策の1日でした！", "横浜", "神奈川県", now()- INTERVAL 5 MINUTE, now()),
    (5, "駅前で集合、人やばい。", "自由が丘", "東京都", now()- INTERVAL 9 HOUR, now()),
    (5, "スタバでいっぱい！新作のフラペチーノ美味しい♡", "自由が丘", "東京都", now()- INTERVAL 8 HOUR, now()),
    (5, "メインストリートをゆっくりお散歩", "自由が丘", "東京都", now()- INTERVAL 5.5 HOUR, now()),
    (5, "デザート食べまくってお昼スキップー！ジェラート美味しすぎた！", "自由が丘", "東京都", now()- INTERVAL 4 HOUR, now()),
    (5, "雑貨屋さんに行ってきたよー！", "自由が丘", "東京都", now()- INTERVAL 2.5 HOUR, now()),
    (5, "ディナーはイタリアン！ラボエムにいってきたよー！オシャレな内装でおすすめ！", "自由が丘", "東京都", now()- INTERVAL 1 HOUR, now()),
    (5, "夜景すごくキレイだった！！また来たい街だなー自由が丘！", "自由が丘", "東京都", now()- INTERVAL 20 MINUTE, now()),
...
insert into photos (post_id, user_id, filename, created, modified) values 
    (null, 1, 'daichi.jpg', now(), now()),
    (null, 2, 'kohei.jpg', now(), now()),
    (null, 3, 'taniguchi.jpg', now(), now()),
    (null, 4, 'miwa.jpg', now(), now()),
    (null, 5, 'aragaki.jpg', now(), now()),
    (null, 6, 'mitsuki.jpg', now(), now()), 
    (null, 7, 'kondo.jpg', now(), now()),
    (null, 8, 'horikita.jpg', now(), now()),
    (4, null, 'rakucafe.jpg', now(), now()),
    (2, null, 'hachikou.jpg', now(), now()),
    (3, null, 'TOHO.jpg', now(), now()),
    (1, null, 'shibuya.jpg', now(), now()),
    (5, null, 'loft.jpg', now(), now()),
    (6, null, 'harajuku.jpg', now(), now()),
    (7, null, 'omotesando.jpg', now(), now()),
    (42, null, 'shinjuku.jpg', now(), now()),
    (12, null, 'daikanyama.jpg', now(), now()),
    (16, null, 'enoshima.jpg', now(), now()),
    (17, null, 'enoden1.jpg', now(), now()),
    (18, null, 'shichirigahama.jpg', now(), now()),
    (19, null, 'enoshimanohashi.jpg', now(), now()),
    (20, null, 'shirasudon.jpg', now(), now()),
    (21, null, 'enoshimayakei.jpg', now(), now()),
    (22, null, 'yokohama.jpg', now(), now()),
