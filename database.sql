...
insert into dates (couple_id, name, description, budget, num_view, post_updated, created, modified) values 
    (1, "渋谷満喫デート", "晴れの日を二人で過ごしました。お金がなかったので、有名どころを回って来ました(^^)", "4000", 4, now(), now(),now()),
    (1, "中目黒ゆったりデート", "ゆったりと静かなひとときを過ごせます。ちょっぴり大人なカップル向けだと思います！", "10000", 20, now(), now(),now()),
    (1, "代官山の大人の休日デート", "オシャレなショップやカフェが立ち並び、有名人がたくさん住んでいる街、代官山。休日に行きたいデートです！", "8000", 4, now(), now(),now()),
    (1, null, null, null, 0, now(), now(),now()),
    (2, "自由が丘デート", "オシャレな街、自由が丘。カフェや雑貨屋さんを見てきました。まったりしたい方におすすめです！！", "5000", 6,now(), now(),now()),
    (2, "お財布に優しい二子玉川デート", "オシャレな街、自由が丘。カフェや雑貨屋さんを見てきました。まったりしたい方におすすめです！！", "5000", 6,now(), now(),now()),
    (3, "江ノ島デート", "夏ということで江ノ島に行ってきました！海に入らなくても江ノ島は楽しいですよ！", "6000", 7, now(), now(),now()),
    (3, "鎌倉プチ旅行デート", "夏ということで江ノ島に行ってきました！海に入らなくても江ノ島は楽しいですよ！", "6000", 7, now(), now(),now()),
    (4, "夕方からの新宿デート", "今からデモを披露いたします！！", "100億", 5, now(), now(),now()),
    (4, "六本木デート", "今からデモを披露いたします！！", "100億", 5, now(), now(),now());
...
insert into posts (date_id, content, state, city, created, modified) values 
    ...
    (3, "ヒカリエに集合！天気も良好◎　さすが晴れ男！！", "渋谷", "東京都", now(), now()),
    (3, "ハチ公前で写真撮影！いぇーい！！", "渋谷", "東京都", now(), now()),
    (3, "TOHOシネマで映画鑑賞！疲れてたからちょっと寝ちゃった…笑", "渋谷", "東京都", now(), now()),
    (3, "楽天カフェで一休み！ワンピースの音楽が永遠リピート。。。懐かしい！！", "渋谷","東京都", now(), now()),
    (4, "ヒカリエに集合！天気も良好◎　さすが晴れ男！！", "渋谷", "東京都", now(), now()),
    (4, "ハチ公前で写真撮影！いぇーい！！", "渋谷", "東京都", now(), now()),
    (4, "TOHOシネマで映画鑑賞！疲れてたからちょっと寝ちゃった…笑", "渋谷", "東京都", now(), now()),
    (4, "楽天カフェで一休み！ワンピースの音楽が永遠リピート。。。懐かしい！！", "渋谷","東京都", now(), now()),
    ...
    (7, "駅前で集合、彼氏が遅刻！", "藤沢駅", "神奈川県", now(), now()),
    (7, "はじめての江ノ電！ローカル線すぎるー！ゆっくり動くー！", "江の電", "神奈川県", now(), now()),
    (7, "江ノ電で途中下車、スラムダンク発祥の高校があるみたい", "七里ガ浜駅", "神奈川県", now(), now()),
    (7, "江の島到着！江の島って橋を渡っていけるんだね！散歩行ってきまーす！", "江の島", "神奈川県", now(), now()),
    (7, "江の島といえば、しらす丼だよね！美味しい！", "江の島", "神奈川県", now(), now()),
    (7, "夜も綺麗な江の島ー！でもお店閉まるの早すぎ！早めの帰宅ー", "江の島", "神奈川県", now(), now()),
    (7, "家に帰って来ちゃった〜！江の島散策の1日でした！", "横浜", "神奈川県", now(), now()),
